                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 justify-items-center max-w-4xl mx-auto">
                    ...
                    <Card className="flex flex-col border-primary w-full">
                        <CardHeader>
                            ...
                            <div className="mt-4">
                                <span className="text-3xl font-bold">{annual ? "$4" : "$6"}</span>
                                <span className="text-muted-foreground"> /month</span>
                            </div>
                            <div className="flex items-center space-x-2">
                                <Switch id="annual" checked={annual} onCheckedChange={setAnnual} />
                                <Label htmlFor="annual" className="text-muted-foreground">Billed annually</Label>
                            </div>
                        </CardHeader>
                        <CardContent className="flex-1">
                            <ul className="space-y-2">
                        ...
                        <CardFooter>
                            <Button className="w-full" onClick={async () => {
                                ...
                                await authClient.subscription.upgrade({
                                    plan: "pro",
                                    annual: annual,
                                    successUrl: "/subscribe?success=true",
                                    cancelUrl: "/pricing",
                                    onError: (err) => {
                                        console.error(err);
